...
public class MealTestData {
    ...
    public static final Meal MEAL4 = new Meal(MEAL_ID + 3, LocalDateTime.of(2020, Month.AUGUST, 12, 00, 0), "Еда на граничное значение", 100);
    ...
    public static final Meal ADMIN_MEAL1 = new Meal(ADMIN_MEAL_ID + 1, LocalDateTime.of(2020, Month.AUGUST, 13, 13, 35), "Обед админа", 500);
    public static final Meal ADMIN_MEAL2 = new Meal(ADMIN_MEAL_ID + 2, LocalDateTime.of(2020, Month.AUGUST, 13, 19, 45), "Ужин админа", 410);
    ...
    public static Meal getUpdated() {
        Meal updated = MEAL3;
        updated.setDateTime(LocalDateTime.of(2020, Month.AUGUST, 15, 15, 15));
