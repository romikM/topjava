...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        List<MealTo> mealsTo = getFilteredWithExceed(mealsList, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIES_LIMIT);
        mealsTo.forEach(System.out::println);
    }

    public static List<MealTo> getListWithExceed(Collection<Meal> meals, int caloriesPerDay) {
        return getFilteredWithExceed(meals, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }

    public static List<MealTo> getFilteredWithExceed(Collection<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
